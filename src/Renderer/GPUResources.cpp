...
DepthStencilCreation& DepthStencilCreation::set_depth(
    bool write, VkCompareOp comparison_test) {
...
// BlendState  /////////////////////////////////////////////
BlendState& BlendState::set_color(VkBlendFactor source,
...
BlendState& BlendState::set_alpha(VkBlendFactor source,
                                  VkBlendFactor destination,
                                  VkBlendOp operation) {
  source_alpha = source;
...
BufferCreation& BufferCreation::set(VkBufferUsageFlags flags,
                                    ResourceUsageType::Enum usage_, u32 size_) {
  type_flags = flags;
  usage = usage_;
  size = size_;
...
// TextureCreation /////////////////////////////////////////
TextureCreation& TextureCreation::set_size(u16 width_, u16 height_,
                                           u16 depth_) {
  width = width_;
  height = height_;
  depth = depth_;
...
TextureCreation& TextureCreation::set_format_type(VkFormat format_,
...
// TextureViewCreation ////////////////////////////////////////////////////
TextureViewCreation& TextureViewCreation::set_parent_texture(
    TextureHandle parent_texture_) {
  parent_texture = parent_texture_;

  return *this;
}

TextureViewCreation& TextureViewCreation::set_mips(u32 base_mip_,
                                                   u32 mip_level_count_) {
...
TextureViewCreation& TextureViewCreation::set_array(u32 base_layer_,
                                                    u32 layer_count_) {
...
SamplerCreation& SamplerCreation::set_reduction_mode(
...
ShaderStateCreation& ShaderStateCreation::add_stage(
    cstring code, u32 code_size, VkShaderStageFlagBits type) {
...
DescriptorSetLayoutCreation& DescriptorSetLayoutCreation::add_binding(
...
DescriptorSetLayoutCreation& DescriptorSetLayoutCreation::set_name(
    cstring name_) {
  name = name_;
  return *this;
}

DescriptorSetLayoutCreation& DescriptorSetLayoutCreation::set_set_index(
    u32 index) {
  set_index = index;
  return *this;
}
...
void DescriptorSetLayoutCreation::sort_bindings_by_index() {
  auto compare_function = [](void const* a, void const* b) -> int {
    ...
    if (binding_a->index < binding_b->index) return -1;
    if (binding_a->index > binding_b->index) return 1;
    return 0;
  };

  qsort(bindings, num_bindings, sizeof(DescriptorSetLayoutCreation::Binding),
        compare_function);
}
...
DescriptorSetCreation& DescriptorSetCreation::set_layout(
    DescriptorSetLayoutHandle layout_) {
  layout = layout_;
  return *this;
}

DescriptorSetCreation& DescriptorSetCreation::texture(TextureHandle texture,
                                                      u16 binding) {
...
DescriptorSetCreation& DescriptorSetCreation::buffer(BufferHandle buffer,
                                                     u16 binding) {
  samplers[num_resources] = k_invalid_sampler;
  bindings[num_resources] = binding;
...
DescriptorSetCreation& DescriptorSetCreation::texture_sampler(
    TextureHandle texture, SamplerHandle sampler, u16 binding) {
  bindings[num_resources] = binding;
  resources[num_resources] = texture.index;
...
void DescriptorSetCreation::sort_bindings_by_index() {
  ...
  std::sort(indices.begin(), indices.end(),
            [&](u16 i, u16 j) { return bindings[i] < bindings[j]; });
...
VertexInputCreation& VertexInputCreation::add_vertex_stream(
    const VertexStream& stream) {
  vertex_streams[num_vertex_streams++] = stream;
  return *this;
}

VertexInputCreation& VertexInputCreation::add_vertex_attribute(
...
RenderPassOutput& RenderPassOutput::depth_stencil(VkFormat format,
                                                  VkImageLayout final_layout) {
...
PipelineCreation& PipelineCreation::add_descriptor_set_layout(
...
RenderPassCreation& RenderPassCreation::add_attachment(
    VkFormat format, VkImageLayout layout, RenderPassOperation::Enum load_op) {
...
RenderPassCreation& RenderPassCreation::set_depth_stencil(
...
FramebufferCreation& FramebufferCreation::add_render_texture(
...
FramebufferCreation& FramebufferCreation::set_depth_stencil_texture(
    TextureHandle texture) {
...
FramebufferCreation& FramebufferCreation::set_scaling(f32 scale_x_,
                                                      f32 scale_y_,
                                                      u8 resize_) {
  scale_x = scale_x_;
  scale_y = scale_y_;
...
ExecutionBarrier& ExecutionBarrier::add_image_barrier(
...
ExecutionBarrier& ExecutionBarrier::add_buffer_barrier(
...
void util_add_image_barrier(GpuDevice* gpu, VkCommandBuffer command_buffer,
                            Texture* texture, ResourceState new_state,
  ...
  util_add_image_barrier(gpu, command_buffer, texture->vk_image, texture->state,
                         new_state, base_mip_level, mip_count, is_depth,
                         source_family, destination_family, source_queue_type,
                         destination_queue_type);
  texture->state = new_state;
}

void util_add_image_barrier(GpuDevice* gpu, VkCommandBuffer command_buffer,
                            VkImage image, ResourceState old_state,
                            ResourceState new_state, u32 base_mip_level,
                            u32 mip_count, bool is_depth, u32 source_family,
                            u32 destination_family,
                            QueueType::Enum source_queue_type,
                            QueueType::Enum destination_queue_type) {
  if (gpu->gpu_device_features & GpuDeviceFeature_SYNCHRONIZATION2) {
    ...
    barrier.srcStageMask = util_determine_pipeline_stage_flags2(
        barrier.srcAccessMask, source_queue_type);
    barrier.dstAccessMask = util_to_vk_access_flags2(new_state);
    barrier.dstStageMask = util_determine_pipeline_stage_flags2(
        barrier.dstAccessMask, destination_queue_type);
    ...
    const VkPipelineStageFlags source_stage_mask =
        util_determine_pipeline_stage_flags(barrier.srcAccessMask,
                                            source_queue_type);
    const VkPipelineStageFlags destination_stage_mask =
        util_determine_pipeline_stage_flags(barrier.dstAccessMask,
                                            destination_queue_type);

    vkCmdPipelineBarrier(command_buffer, source_stage_mask,
                         destination_stage_mask, 0, 0, nullptr, 0, nullptr, 1,
                         &barrier);
  }
}

void util_add_buffer_barrier(GpuDevice* gpu, VkCommandBuffer command_buffer,
                             VkBuffer buffer, ResourceState old_state,
                             ResourceState new_state, u32 buffer_size) {
  util_add_buffer_barrier_ext(gpu, command_buffer, buffer, old_state, new_state,
                              buffer_size, VK_QUEUE_FAMILY_IGNORED,
                              VK_QUEUE_FAMILY_IGNORED, QueueType::Graphics,
                              QueueType::Graphics);
}

void util_add_buffer_barrier_ext(GpuDevice* gpu, VkCommandBuffer command_buffer,
                                 VkBuffer buffer, ResourceState old_state,
                                 ResourceState new_state, u32 buffer_size,
                                 u32 source_family, u32 destination_family,
                                 QueueType::Enum source_queue_type,
  ...
  if (gpu->gpu_device_features & GpuDeviceFeature_SYNCHRONIZATION2) {
    ...
    vkCmdPipelineBarrier(command_buffer, source_stage_mask,
                         destination_stage_mask, 0, 0, nullptr, 1, &barrier, 0,
                         nullptr);
  }
}
...
VkFormat util_string_to_vk_format(cstring format) {
  ...
  if (strcmp(format, "VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16") ==
      0) {
    return VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16;
  }
  if (strcmp(format, "VK_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16") ==
      0) {
    return VK_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16;
  }
  if (strcmp(format, "VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16") ==
      0) {
    return VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16;
  }
  if (strcmp(format, "VK_FORMAT_G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16") ==
      0) {
    return VK_FORMAT_G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16;
  }
  if (strcmp(format, "VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16") ==
      0) {
  ...
  if (strcmp(format, "VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16") ==
      0) {
    return VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16;
  }
  if (strcmp(format, "VK_FORMAT_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16") ==
      0) {
    return VK_FORMAT_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16;
  }
  if (strcmp(format, "VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16") ==
      0) {
    return VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16;
  }
  if (strcmp(format, "VK_FORMAT_G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16") ==
      0) {
    return VK_FORMAT_G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16;
  }
  if (strcmp(format, "VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16") ==
      0) {
  ...
  if (strcmp(format,
             "VK_FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16_EXT") == 0) {
    return VK_FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16_EXT;
  }
  if (strcmp(format,
             "VK_FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16_EXT") == 0) {
...
//
//
static VkPipelineStageFlags util_determine_pipeline_stage_flags(
    VkAccessFlags accessFlags, QueueType::Enum queueType) {
...
VkPipelineStageFlags2 util_determine_pipeline_stage_flags2(
    VkAccessFlags2 access_flags, QueueType::Enum queue_type) {
  ...
  if (flags == 0) flags = VK_PIPELINE_STAGE_2_TOP_OF_PIPE_BIT;
