...
vec4 positions [] = {
  vec4(-1.f, 1.f, -1.f, 1.f),  // Near Top Left
  vec4(1.f, 1.f, -1.f, 1.f),   // Near Top Right

  vec4(1.f, 1.f, -1.f, 1.f),   // Near Top Right
  vec4(1.f, -1.f, -1.f, 1.f),  // Near Bottom Right

  vec4(1.f, -1.f, -1.f, 1.f),  // Near Bottom Right
  vec4(-1.f, -1.f, -1.f, 1.f), // Near Bottom Left
...
void main() {
  ...
  gl_Position = viewProj * vec4(ndc_to_world_space(invViewProj, position.x, position.y, position.z), 1.f);
}
